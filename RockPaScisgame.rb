puts 'Let us Play a Game of Rock Paper Scissors. The winner will be the first to prevail in win five bouts!'
...
while player_score < 5 && computer_score < 5
  ...
  puts 'Please throw a (r)ock, (p)aper or (s)cissors. Then press the enter key.'
